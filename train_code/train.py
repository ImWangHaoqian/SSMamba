    ...
    while iteration<total_iteration:
        ...
        for i, (images, labels) in enumerate(train_loader):
            ...
            if iteration % 20 == 0:
                ...
                remaining_time = (total_iteration - iteration) * (elapsed_time / iteration)
                remaining_time_str = str(datetime.timedelta(seconds=int(remaining_time)))
                print('[iter:%d/%d],lr=%.9f,train_losses.avg=%.9f,trmaining_time=%s'
                      % (iteration, total_iteration, lr, losses.avg, remaining_time_str))
            if iteration % 1000 == 0:
